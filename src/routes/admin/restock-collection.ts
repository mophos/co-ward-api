...
import { RestocCollectionkModel } from '../../models/restock-collection';
...
const restocCollectionkModel = new RestocCollectionkModel();
...
router.get('/', async (req: Request, res: Response) => {
  ...
  try {
    let rs: any = await restocCollectionkModel.getRestockCollection(req.db, +limit, +offset);
    let rsTotal: any = await restocCollectionkModel.getRestockCollectionTotal(req.db);
